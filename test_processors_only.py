"""
Test only document processors without vector store dependencies.
"""
import os
import tempfile
import shutil
...
try:
    # Test document processors directly without importing the full RAG module
    ...
    print("\n✅ Document processors work correctly!")
